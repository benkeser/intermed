...
if (args[1] == 'run') {
  ...
  for (i in (id+TASKID):(id+TASKID+STEPSIZE-1)) {
    ...
    gcomp_cil <- apply(cbind(boot_gcomp_total, boot_gcomp_direct, boot_gcomp_indirectM1, boot_gcomp_indirectM2, boot_gcomp_covarM1M2), 2, quantile, p = 0.025)
    gcomp_ciu <- apply(cbind(boot_gcomp_total, boot_gcomp_direct, boot_gcomp_indirectM1, boot_gcomp_indirectM2, boot_gcomp_covarM1M2), 2, quantile, p = 0.975)
